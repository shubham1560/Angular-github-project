...
(function() {
    ...
    var pa = function(a) {
            if (a instanceof t && a.constructor === t && a.ga === oa) return a.T;
    ...
    var va = function(a) {
            if (a instanceof z && a.constructor === z && a.ea === ua) return a.G;
    ...
    */
    ...
    var J = function(a, b, c) {
            ...
            b = new RegExp("([?#].*&|[?#])" + b + "=([^&#]*)", "g");
            if (a = a && (d.exec(a) || b.exec(a))) try { c = decodeURIComponent(a[2]) } catch (e) {}
            return c
        },
        ...
        Ya = function(a, b) {
            ...
            a: {
                try {
                    ...
                    g = g || m;
                    if (g.Element && g.Location) { var k = g; break a }
                } catch (l) {}
                k = null
            }
    ...
    var tb = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Bb = function(a, b, c, d) {
            ...
            b = k;
            c = b.match(yb);
            (d = b.match(zb)) && 1 === d.length && Ab.test(b) && c && 1 === c.length || O("failed sanity: " + a);
            return k
        },
        Eb = function(a, b, c, d) {
            a = Cb(a);
    ...
    var Hb = decodeURI("%73cript"),
        ...
        Rb = function(a, b) {
            ...
            if (e["::"] && b.length) {
                ...
                if (1 < l) {
                    var n = c.callback;
                    n && (c.callback = function() { 0 == --l && n() })
                }
                for (; b = a.shift();) Qb(b.Y, c, b.hint)
            } else Qb(b || [], c, d)
        },
        Qb = function(a,
            b, c) {
            ...
            var p = C(kb(c), "L", []).sort(),
                ...
                u = function(M, ea) {
                    ...
                    if (ea) { qb("me0", M, r); try { Pb(ea, c, h) } finally { qb("me1", M, r) } }
                    return 1
                };
            ...
            if (y.length) {
                ...
                F[K] = function(M) {
                    ...
                    0 < K && F[K - 1] ? F[K] = function() { ea(fa) } : ea(fa)
                };
                if (y.length) {
                    var Qa = "loaded_" + L.I++;
                    I[Qa] = function(M) {
                    ...
                    k.push.apply(k, y);
                    qb("ml0", y, r);
                    b.sync || A.___gapisync ? Mb(a) : Lb(a)
                } else F[K](Ba)
            } else u(y) && d && d()
        };
    ...
    var $b = { callback: 1, clientid: 1, cookiepolicy: 1, openidrealm: -1, includegrantedscopes: -1, requestvisibleactions: 1, scope: 1 },
        ...
        cc = function() {
            if (!ac) {
                ...
                if (window.self !== window.top) { a = document.location.toString(); for (var e in $b) 0 < $b[e] && (b = J(a, e, "")) && (bc[e] = b) }
                ac = !0
            }
            e = D();
            G(bc, e);
    ...
    Uc.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.l, d = 0, e = this.K, f = this.A; d < b;) {
                if (0 == f)
                    for (; d <= c;) Vc(this, a, d), d += this.l;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    var fd = function() {
            ...
            cd = ed(cd);
            return a / (bd + Math.pow(16, 20))
        },
        gd = function() {
            var a = new A.Uint32Array(1);
            Xc.getRandomValues(a);
            return Number("0." + a[0])
        };
    var hd = function() {
            var a = L.onl;
    ...
    var qd = /^:[\w]+$/,
        ...
        sd = function() {
            ...
            return kc = { socialhost: f, ctx_socialhost: d ? g : f, session_index: a, session_delegate: b, session_prefix: c, im_prefix: e }
        },
    ...
    var vd = function(a) {
        ...
        wd = function(a) {
            ...
            for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = vd(e)) && null != e.match(/^https?:\/\/[\w\-_\.]+/i)) return e
            }
    ...
    var Pd = function(a, b) { Od(void 0, !1, a, b) },
        Od = function(a, b, c, d) {
            ...
            if (c.querySelectorAll && (!e || 8 < e)) {
                e = d ? [d] : La(Id).concat(La(Jd)).concat(La(X));
        ...
        Ud = function(a) {
            var b = C(I, a, {});
            b.go || (b.go = function(c) { return Pd(c, a) }, b.render = function(c, d) {
                d = d || {};
                d.type = a;
                return Gd(c, d)
            })
    ...
    var Rd = function(a, b) {
        ...
        Gd = function(a, b) {
            ...
            if (d) {
                ...
                Td(c, e)
            } else fc("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
        };
    C(I, "platform", {}).go = Pd;
    Qd = function(a) {
    ...
    sb.push(["platform", function(a, b, c) {
        ...
        if ("explicit" != Q("parsetags")) {
            hb(a);
            dc(cc()) && !Q("disableRealtimeCallback") && hc();
            if (c && (a = c.callback)) {
                var d = Ma(a);
                delete c.callback
            }
            ...
            function d(f) {
                ...
                if (ee(g, b)) {
                    ...
                    fe(a, function() {
                        h && N("rqd");
                        c();
                        for (var l = C(L, "RPMQ", []), n = 0; n < l.length; n++) l[n]({ data: g, origin: k })
                    })
                }
            }
            if (0 !== b.length) {
    ...
    ge.prototype.write = function(a, b) {
        if (!ie.test(this.M)) throw "Invalid cookie name";
    ...
    var ke = "https:" === window.location.protocol,
        ...
        ne = function() {
            var a, b = null;
            le.iterate(function(c, d) { 0 === c.indexOf("G_AUTHUSER_") && (c = me(c.substring(11)), !a || c.j && !a.j || c.j == a.j && c.o > a.o) && (a = c, b = d) });
            return { ia: a, J: b }
        };
    var oe = function(a) {
            ...
            if (-1 == d) return b;
            var e = me(a.substr(d + 1));
            if (null == e) return b;
            a = a.substring(0, d);
            if ("_" !== a.charAt(0)) return b;
            d = "E" === c && e.j;
            return !d && ("U" !== c || e.j) || d && !ke ? b : { Z: !0, j: d, na: a.substr(1), domain: e.domain, o: e.o }
        },
        pe = function(a) {
            if (!a) return [];
            a = a.split("=");
        ...
        re = function() {
            ...
            if (null !== a) {
                ...
                le.iterate(function(f, g) {
                    (f = oe(f)) && f.Z && f.j == b.j && f.o == b.o && (c = g)
                });
                if (c) {
                    var d = qe(c),
                        e = d && d.ma[Number(a)];
